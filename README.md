...
2. Luhn Algorithm is used to validate the card number
3. Global exception handling where a detailed exception will show if the environment is in "development", otherwise a generic "Internal server error" message will show.
